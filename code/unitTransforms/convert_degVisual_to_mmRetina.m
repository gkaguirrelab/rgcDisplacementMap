...
supportPosMmRetinaRelativeToVisualAxis = ...
    ...
    drasdoAndFowlerConversionRetinaToField(abs(supportPosDegVisualRelativeToVisualAxis - supportPosDegVisualRelativeToOpticalAxis)) ) + ...
    drasdoAndFowlerConversionRetinaToField(supportPosDegVisualRelativeToOpticalAxis);
