...
supportPosDegVisualFieldRelativeToVisualAxis = ...
    ( sign(supportPosMmRetinaRelativeToVisualAxis - supportPosMmRetinaRelativeToOpticalAxis) .* ...
    drasdoAndFowlerConversionRetinaToField(abs(supportPosMmRetinaRelativeToVisualAxis - supportPosMmRetinaRelativeToOpticalAxis)) ) + ...
