...
distanceToOpticDiscCenterDegRetina = sqrt(...
    ...
    2.*opticDiscParameters.e.*regularSupportPosDeg.*cos(deg2rad(polarAngle-opticDiscParameters.m)));
...
% optic disc
angleWithOpticDiscCenter =  ...
    rad2deg( ...
            asin( ...
              (sin(deg2rad(polarAngle-opticDiscParameters.m))./regularSupportPosDeg)./distanceToOpticDiscCenterDegRetina ...
                  )...
           ) + ...
    opticDiscParameters.theta;
...
opticDiscIndices = distanceToOpticDiscCenterDegRetina < ...
                    ( ...
                       (opticDiscParameters.major*opticDiscParameters.minor) ./ sqrt( (opticDiscParameters.minor.*cos(deg2rad(angleWithOpticDiscCenter)).^2 + ...
                       (opticDiscParameters.major.*sin(deg2rad(angleWithOpticDiscCenter)).^2  ))) ...
                    );
