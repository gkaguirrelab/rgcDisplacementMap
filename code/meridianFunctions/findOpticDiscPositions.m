...
opticDiscIndices = distanceToOpticDiscCenterDegRetina < ...
                    ( ...
                       (opticDiscParameters.major/2*opticDiscParameters.minor/2) ./ sqrt( (opticDiscParameters.minor/2.*cos(deg2rad(beta)).^2 + ...
                       (opticDiscParameters.major/2.*sin(deg2rad(beta)).^2  ))) ...
                    );
